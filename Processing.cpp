...
Description: Creates record to hold and retrieve country data
Date: October 7, 2020
*/
...
*/
bool Processing::AscNewCaseSort(Record first, Record second)
{
...
*/
bool Processing::DesNewCaseSort(Record first, Record second)
{
    return first.getNewCases() > second.getNewCases();
}
...
*/
bool Processing::AscNewDeathSort(Record first, Record second)
{
...
*/
bool Processing::DesNewDeathSort(Record first, Record second)
{
    return first.getNewDeaths() > second.getNewDeaths();
}
...
*/
bool Processing::AscNewRecoverySort(Record first, Record second)
{
...
*/
bool Processing::DesNewRecoverySort(Record first, Record second)
{
    return first.getNewRecovery() > second.getNewRecovery();
}
...
*/
bool Processing::AscTotalCaseSort(Record first, Record second)
{
...
*/
bool Processing::DesTotalCaseSort(Record first, Record second)
{
    return first.getTotalCases() > second.getTotalCases();
}
...
*/
bool Processing::AscTotalDeathSort(Record first, Record second)
{
...
*/
bool Processing::DesTotalDeathSort(Record first, Record second)
{
    return first.getTotalDeaths() > second.getTotalDeaths();
}
...
*/
bool Processing::AscTotalRecoverySort(Record first, Record second)
{
...
*/
bool Processing::DesTotalRecoverySort(Record first, Record second)
{
    return first.getTotalRecovery() > second.getTotalRecovery();
}
...
Return: returns void
*/
void Processing::getCovidData(vector<Record> &countryData)
{
...
Return: returns void
*/
void Processing::sortData(int sortBy, int sortType, string &sorted, vector<Record> &countryData)
{
...
Return: returns void
*/
void Processing::graphData(int sortBy, int sortType, string sorted, vector<Record> countryData)
{
